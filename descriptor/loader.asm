...
;创建#1描述符，保护模式下的代码段描述符 base:0x00008000 limit:0x0000ffff G:0 D:1 L:0 AVL:0 P:1 DPL:00 S:1 TYPE:1000
mov dword [es:0x08],0x8000ffff
mov dword [es:0x0c],0x00409800 ; 00000000 0100 0000 1001 1000 00000000

;创建#2描述符，保护模式下的数据段描述符（文本模式下的显示缓冲区）
;mov dword [es:0x10],0x8000ffff
;mov dword [es:0x14],0x0040920b

								; base:0x00000000 limit:0x0000ffff 4kb G:1 D:1 L:0 AVL:0 P:1 DPL:00 S:1 TYPE:0010
mov dword [es:0x10],0x0000ffff  ;（把DS的基地址定义为0） 
mov dword [es:0x14],0x00c09200  ; (标志位G=1,表示以KB为单位) 00000000 1100 0000 1001 0010 00000000

;创建#3描述符，保护模式下的堆栈段描述符 base:0x00000000 limit:0x00007a00 G:0 D:1 L:0 AVL:0 P:1 DPL:00 S:1 TYPE:0110 
mov dword [es:0x18],0x00007a00
mov dword [es:0x1c],0x00409600 ; 00000000 0100 0000 1001 0110 00000000
ret
